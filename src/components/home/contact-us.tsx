...
function Contactus() {
  return (
    <div
      id="contact"
      className="grid sm:grid-cols-2 items-center gap-16 my-6 mx-auto max-w-4xl bg-white text-[#333] scroll-m-16 font-[sans-serif]"
    >
      <div>
        ...
        <p className="text-sm text-gray-400 mt-3">
          ...
          itaque voluptate minima eum delectus. Provident voluptas alias minima.
          Recusandae minus eos vero consequuntur, iste animi incidunt eius
          cumque ea fugit!
        </p>
        <div className="mt-12">
